        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left">
            ...
            <div>
              ...
              <div className="mb xl:mb-8">
                <Socials
                  containerStyles={'flex gap-6'}
                  iconStyles={'w-9 h-9 border border-accent rounded-full flex justify-center items-center text-accent text-base hover:bg-accent hover:text-primary hover:transition-a duration-500'}
                />
              </div>
            </div>
          </div>
